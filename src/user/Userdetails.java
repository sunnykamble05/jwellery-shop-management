...
public class Userdetails extends javax.swing.JFrame {
    ...
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(Userdetails.class.getName());
   ...
   public void loadUserData() {
        ...
        try {
             Class.forName("com.mysql.cj.jdbc.Driver");
              java.sql.Connection con= java.sql.DriverManager.getConnection("jdbc:mysql://localhost:3306/project","root","kokate@80100");
    ...
    private void initComponents() {
        ...
        userdetails.setFont(new java.awt.Font("Times New Roman", 3, 36)); // NOI18N
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addComponent(userdetails, javax.swing.GroupLayout.PREFERRED_SIZE, 370, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(306, 306, 306))
        );
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(userdetails, javax.swing.GroupLayout.DEFAULT_SIZE, 44, Short.MAX_VALUE)
                .addContainerGap())
        );
        ...
        Usertable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "UserID", "UserName", "Email", "Contact", "Address"
            }
        ) {
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new Userdetails().setVisible(true));
    }
